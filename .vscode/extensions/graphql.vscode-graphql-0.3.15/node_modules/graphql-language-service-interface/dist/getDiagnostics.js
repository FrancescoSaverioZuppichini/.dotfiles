...
function validateQuery(ast, schema = null, customRules, isRelayCompatMode) {
    ...
    const deprecationWarningAnnotations = !graphql_1.NoDeprecatedCustomRule && graphql_2.findDeprecatedUsages
        ? mapCat(graphql_2.findDeprecatedUsages(schema, ast), error => annotations(error, exports.DIAGNOSTIC_SEVERITY.Warning, 'Deprecation'))
        : mapCat(graphql_2.validate(schema, ast, [graphql_1.NoDeprecatedCustomRule]), error => annotations(error, exports.DIAGNOSTIC_SEVERITY.Warning, 'Deprecation'));
