...
**[Follow the step-by-step tutorial](https://code.visualstudio.com/docs/remote/containers-tutorial)** or if you are comfortable with Docker, follow these four steps:
