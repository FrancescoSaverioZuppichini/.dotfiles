...
import { ClientCapabilities, LanguageService as JSONLanguageService } from 'vscode-json-languageservice';
export declare const workspaceContext: {
    resolveRelativePath: (relativePath: string, resource: string) => string;
};
export declare const schemaRequestService: (uri: string) => Promise<string>;
export declare function toFsPath(str: unknown): string;
export declare function configureLanguageService(languageSettings: LanguageSettings, clientCapabilities?: ClientCapabilities): LanguageService;
