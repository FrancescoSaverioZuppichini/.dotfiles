...
export function validateQuery(ast, schema = null, customRules, isRelayCompatMode) {
    ...
    const deprecationWarningAnnotations = !NoDeprecatedCustomRule && findDeprecatedUsages
        ? mapCat(findDeprecatedUsages(schema, ast), error => annotations(error, DIAGNOSTIC_SEVERITY.Warning, 'Deprecation'))
        : mapCat(validate(schema, ast, [NoDeprecatedCustomRule]), error => annotations(error, DIAGNOSTIC_SEVERITY.Warning, 'Deprecation'));
