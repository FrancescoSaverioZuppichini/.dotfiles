    ...
    return utils.mapSchema(schema, {
        [utils.MapperKind.ROOT_FIELD]: (fieldConfig, _fieldName, typeName, schema) => {
            ...
            if (subscription != null && subscription.name === typeName) {
                return Object.assign(Object.assign({}, fieldConfig), { resolve: wrapResolver(fieldConfig.resolve, fn) });
            }
            return Object.assign(Object.assign({}, fieldConfig), { resolve: wrapResolver(fieldConfig.resolve, fnToRunOnlyOnce) });
        },
    });
}
...
function attachDirectiveResolvers(schema, directiveResolvers) {
    ...
    return utils.mapSchema(schema, {
        [utils.MapperKind.OBJECT_FIELD]: fieldConfig => {
            const newFieldConfig = Object.assign({}, fieldConfig);
...
function extendResolversFromInterfaces(schema, resolvers) {
    ...
    typeNames.forEach(typeName => {
        ...
        if ('getInterfaces' in type) {
            ...
            extendedResolvers[typeName] = Object.assign(Object.assign({}, extendedResolvers[typeName]), typeResolvers);
        }
        else {
            const typeResolvers = resolvers[typeName];
...
function createNewSchemaWithResolvers(schema, resolvers, defaultFieldResolver) {
    ...
    if (defaultFieldResolver != null) {
        schema = utils.mapSchema(schema, {
            [utils.MapperKind.OBJECT_FIELD]: fieldConfig => (Object.assign(Object.assign({}, fieldConfig), { resolve: fieldConfig.resolve != null ? fieldConfig.resolve : defaultFieldResolver })),
        });
    }
    return schema;
}
...
function addErrorLoggingToSchema(schema, logger) {
    ...
    return utils.mapSchema(schema, {
        [utils.MapperKind.OBJECT_FIELD]: (fieldConfig, fieldName, typeName) => (Object.assign(Object.assign({}, fieldConfig), { resolve: decorateWithLogger(fieldConfig.resolve, logger, `${typeName}.${fieldName}`) })),
    });
}
...
function addCatchUndefinedToSchema(schema) {
    return utils.mapSchema(schema, {
        [utils.MapperKind.OBJECT_FIELD]: (fieldConfig, fieldName, typeName) => (Object.assign(Object.assign({}, fieldConfig), { resolve: decorateToCatchUndefined(fieldConfig.resolve, `${typeName}.${fieldName}`) })),
    });
}
