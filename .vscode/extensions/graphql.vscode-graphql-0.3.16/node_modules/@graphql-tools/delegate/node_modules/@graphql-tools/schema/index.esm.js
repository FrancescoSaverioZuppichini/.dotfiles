...
function createNewSchemaWithResolvers(schema, resolvers, defaultFieldResolver) {
    ...
    if (defaultFieldResolver != null) {
        schema = mapSchema(schema, {
            [MapperKind.OBJECT_FIELD]: fieldConfig => (Object.assign(Object.assign({}, fieldConfig), { resolve: fieldConfig.resolve != null ? fieldConfig.resolve : defaultFieldResolver })),
        });
    }
    return schema;
}
...
function addErrorLoggingToSchema(schema, logger) {
    ...
    return mapSchema(schema, {
        [MapperKind.OBJECT_FIELD]: (fieldConfig, fieldName, typeName) => (Object.assign(Object.assign({}, fieldConfig), { resolve: decorateWithLogger(fieldConfig.resolve, logger, `${typeName}.${fieldName}`) })),
    });
}
...
function addCatchUndefinedToSchema(schema) {
    return mapSchema(schema, {
        [MapperKind.OBJECT_FIELD]: (fieldConfig, fieldName, typeName) => (Object.assign(Object.assign({}, fieldConfig), { resolve: decorateToCatchUndefined(fieldConfig.resolve, `${typeName}.${fieldName}`) })),
    });
}
